							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="authenticationDomain">认证领域</label>

															<div class=" col-sm-2">
															<select class="form-control" id="authenticationDomain" data-placeholder="请选择">
														...
														<div class="col-sm-1">
										<label class="control-label" for="post">工作岗位</label>
										</div>
										<div class="col-sm-2">
											<input class="input-sm" type="text" id="post"/>
										
										</div>
										<div class="col-sm-1">
											<label class="control-label  " for="specialtyCode">专业代码</label>
										</div>
										<div class="col-sm-2">
											<input type="text" id="specialtyCode" />
										
										</div>
										<div class="col-sm-1">
											<label class="control-label  " for="professionalLevel">专业等级</label>
										</div>
										<div class="col-sm-1">
											<input type="text" id="professionalLevel" />
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="fulltime">专兼职</label>
										...
										<div class="col-sm-2">
											<input class="input-sm" type="text" id="realname"/>
										...
										<div class="col-sm-1">
										<label class="control-label no-padding-right" for="workingCondition">工作状态</label>
										</div>
															<div class=" col-sm-2">
															<select class="form-control" id="workingCondition" data-placeholder="请选择">
																
																<option value="0">在岗</option>
																<option value="1">非在岗</option>
...
//				//注册功能
			...
			function searchAction(){
				...
				//检验界面参数
				var authenticationDomain = $('#authenticationDomain').val().trim();
				var post = $('#post').val().trim();
				var specialtyCode = $('#specialtyCode').val().trim();
				var fulltime = $('#fulltime  option:selected').val().trim();
				//var gender=$("input[name='gender']:checked").val();
				
				//获取界面中表单数据
				var professionalLevel = $('#professionalLevel').val().trim();
				...
				var data = {authenticationDomain:authenticationDomain, 
						post:post, 
						specialtyCode:specialtyCode, 
						fulltime:fulltime,professionalLevele:professionalLevel,realname:realname,location:location,workingCondition:workingCondition};
				//console.log(data);
				// $.post 是 $.ajax的简化版
