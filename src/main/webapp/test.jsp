			...
			<div class="main-container-inner">
							...
							<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<label class="col-sm-2 control-label no-padding-right" for="phone"> 电话 </label>
				...
				<label class="col-sm-3 control-label no-padding-right" for="gender">性别</label>
   				 ...
   				 <div class="form-group">
										...
										<label class="col-sm-2 control-label no-padding-right" for="id_number"> 身份证号 </label>

										<div class="col-sm-3">
											<input type="text" id="id_number" placeholder="身份证号" />
										</div>
									</div>
									<div class="space-4"></div>
						...
						<div class="widget-main">
							<div class="row">
									...
									<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-select-3">工作经历</label>
									<div class="col-sm-8 col">
          				  <textarea id="work_experience"  class="form-control" rows="6"></textarea>
          					  </div>
      					  </div>
